...
function preload() {
    screen = 0;
    //screens
    firstScreen = app.loadImage(path+'assets/pantalla1.png');
    secondScreen = app.loadImage(path+'assets/pantalla2.png');
    thirdScreen = app.loadImage(path+'assets/pantalla3.png');
    gameScreen = app.loadImage(path+'assets/pantallaJuego.png');
    forthScreen = app.loadImage(path+'assets/pantalla4.png');

    //buttons
    startBtn = app.loadImage(path+'assets/btn_jugar.png');
    continueBtn = app.loadImage(path+'assets/btn_continuar.png');

    //bongon
    bongoDefault = app.loadImage(path+'assets/bongo1.png');
    bongoBoth = app.loadImage(path+'assets/bongo2.png');
    bongoPurple = app.loadImage(path+'assets/bongo3.png');
    bongoBlue = app.loadImage(path+'assets/bongo4.png');

    //balls
    blueBalls = app.loadImage(path+'assets/caritaPerfecto.png');
    ...
    //estados
    bueno = app.loadImage(path+'assets/bueno.png');
    malo = app.loadImage(path+'assets/malo.png');
    perfecto = app.loadImage(path+'assets/perfecto.png');
    ...
    bongoAzulSonido = app.loadSound(path+'sounds/soundBongoAzul.mp3');

    //level
    levelCounter = 1;

    //levels songs
    level1 = app.loadSound(path+'sounds/level1.mp3');
    level2 = app.loadSound(path+'sounds/level2.mp3');
...
function keyPressed(){
    ...
    if(screen == 4){
        ...
        if(keyCode === 81 && create2 === true){
            ...
            for(let h = 0; h < purpleArray2.length; h++){
                ...
                actividad.finish() //para acabar la interacción
    ...
    actividad.addState("parametro", value); 
